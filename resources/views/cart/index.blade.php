<x-client-layout>
    <section class="w-full h-full flex flex-1 flex-col ">
        <div class="px-4 lg:px-20 w-full flex flex-row justify-between items-center">
            <h1 class="text-4xl font-bold ">Keranjang</h1>
       ...
       <div class="px-4 mt-10 lg:px-20 w-full flex flex-row justify-between items-center self-center border-b gap-10 border-slate-200 py-4">
        ...
        <p class="text-lg text-center w-1/4  font-medium text-gray-400">Harga</p>
       </div>
       <div class="min-h-96 px-4 mt-10 lg:px-20 w-full flex flex-col gap-4 items-center">
            <div class="w-full flex flex-row justify-between items-center gap-10">
                <div class="w-2/4  flex flex-row gap-4 items-center">
                    <div class="w-24 h-24 bg-slate-200 flex justify-center items-center rounded-lg">
                ...
                <div class="w-1/4 h-fit flex justify-center items-center gap-4">
                    <button type="button" class="text-gray-400 hover:text-white border border-gray-400 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">-</button>
                    <span class=" "> 0 </span>
                    <button type="button" class="text-gray-400 hover:text-white border border-gray-400 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  ">+</button>
                </div>
                <p class="w-1/4 text-center">RP. 500.000</p>
            </div>
            <div class="w-full flex flex-row justify-between items-center gap-10">
                <div class="w-2/4  flex flex-row gap-4 items-center">
                    <div class="w-24 h-24 bg-slate-200 flex justify-center items-center rounded-lg">
